...
public class Game_turn : MonoBehaviour {
	...
	void QuitWindow (int windowID)
	{
		...
		GUI.Label (new Rect (150, 75, 450, 45), "Are you sure you want to Return Menu ?");
		
		if (GUI.Button (new Rect (120, 165, 150, 30), "Return Menu")) {
